...
public class CapsuleColliderUtility
{
    ...
    public void SetCapsuleColliderCenterY(Vector3 center)
    {
        CapsuleColliderData.Collider.center = center;
    }
    ...
    public void RecalculateCapsuleColliderCenter()
    {
        ...
        Vector3 newColliderCenter = new Vector3(0, DefaultColliderData.CenterY + colliderHeightDifference / 2f, 0f);

        SetCapsuleColliderCenterY(newColliderCenter);
    }
}
