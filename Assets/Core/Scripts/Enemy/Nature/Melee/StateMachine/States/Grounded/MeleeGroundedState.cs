...
public class MeleeGroundedState : MeleeState
{
    private SlopeData SlopeData;

    public MeleeGroundedState(MeleeStateMachine MeleeStateMachine) : base(MeleeStateMachine)
    {
    ...
    public override void Update()
    {
        if (GetSqrDstToPlayer() < stateMachine.Enemy.Data.SqrDstToAttack &&
            Time.time > stateMachine.Enemy.CooldownData.StrikeStart + stateMachine.Enemy.CooldownData.StrikeCooldown)
        {
