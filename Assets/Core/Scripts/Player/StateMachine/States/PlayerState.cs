...
public class PlayerState : IState
{
    ...
    public virtual void OnTriggerEnter(Collider collider)
    {
        ...
        if (stateMachine.Player.LayerData.IsEnemyDamageLayer(collider.gameObject.layer))
        {
            stateMachine.Player.TakeDamage(0.5f);
        }
    ...
    {
        stateMachine.Player.Animator.SetFloat(animationHash, directionThreshold);
    }
    ...
    protected void ResetVerticalVelocity()
    {
        ...
        stateMachine.Player.Rigidbody.velocity = new Vector3(velocity.x, 0, velocity.z);
    }
